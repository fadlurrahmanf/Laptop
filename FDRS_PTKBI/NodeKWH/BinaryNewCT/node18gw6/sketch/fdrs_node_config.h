#line 1 "D:\\Proyek\\ESPNow\\FDRS_PTKBI\\NodeKWH\\NodeKWH\\fdrs_node_config.h"
...
uint16_t READING_ID = 18;  //Unique ID for this sensor
uint8_t GTWY_MAC = 0x06;  //Address of the nearest gateway
