...
uint8_t ESPNOW_NEIGHBOR_2 = 0x02;  // Address of ESP-NOW neighbor #2
uint8_t LORA_NEIGHBOR_1  =  0x03;  // Address of LoRa neighbor #1
uint8_t LORA_NEIGHBOR_2  =  0x05;  // Address of LoRa neighbor #2
...
#define LORAG_ACT      sendESPNowNbr(1); //sendESPNow(0x01);
#define SERIAL_ACT     
#define MQTT_ACT          
