...
String WIFI_SSID =  "iotelkafi";  
String WIFI_PASS =  "furuKAWA212";
...
String TOPIC_DATA  =  "iota11/data";
String TOPIC_STATUS = "iota11/status";
String TOPIC_COMMAND = "iota11/command";
