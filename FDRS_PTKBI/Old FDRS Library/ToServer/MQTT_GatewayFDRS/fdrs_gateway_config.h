...
//Addresses
#define UNIT_MAC           0x19  // The address of this gateway
...
String WIFI_SSID =  "rmhmaman5";  
String WIFI_PASS =  "salfarasalfara";
...
String MQTT_ADDR  = "51.15.243.241";
String MQTT_PORT  = "1883";// Default MQTT port is 1883
#define MQTT_AUTH   //Enable MQTT authentication 
String MQTT_USER  = "iotelkafi";
String MQTT_PASS  = "jvnwQu3wt5njx2rM";

String TOPIC_DATA  =  "iotaG2/data";
String TOPIC_STATUS = "iotaG2/status";
String TOPIC_COMMAND = "iotaG2/command";
