...
void loop()
{
  ...
  if (failed) {
     ...
     * to the /uint32_t0\r§mûü   @   p{Ò    CB3338F1950289C009AFD4E93594BFD2CDE703FF4DD9C2752FB9CAE31353AE52    ‰˜#c¯ÞÀaÏ<{4 ½Šà£Pq     $S0¨`   L`   $Sl`   $L`   <Rb„ã         ò ² òb¤ÿ ¤ÿ ¤ÿ I`þÿÿÿDar   b $S``z   L`   QÚ0X   exports ¤a      (‘a      éDr8            Â/ø Äœ-ú ©Â|À4øöùÁ/÷Â-ù 	¿¾ùö\ø÷-ù 	© (Rb„ã‚         ò`þÿÿÿDa|  R  <Rb„ã