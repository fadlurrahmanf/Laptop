...
#define GLOBAL_WIFI_SSID        "iotelkafi"
#define GLOBAL_WIFI_PASS        "furuKAWA212"
...
#define GLOBAL_MQTT_ADDR "51.15.243.241"
#define GLOBAL_MQTT_PORT 1883

//#define GLOBAL_MQTT_AUTH   //uncomment to enable MQTT authentication  
#define GLOBAL_MQTT_USER   "iotelkafi"
#define GLOBAL_MQTT_PASS   "jvnwQu3wt5njx2rM"
// MQTT Topics
//String TOPIC_DATA =    "iota/data";
//String TOPIC_STATUS  = "iota/status";
//String TOPIC_COMMAND = "iota/command";
//String TOPIC_DATA_BACKLOG = "fdrs/databacklog";   // Used in filesystem module
...
#define GLOBAL_LORA_FREQUENCY 920.0   // Carrier frequency in MHz. Allowed values range from 137.0 MHz to 1020.0 MHz (varies by chip).
#define GLOBAL_LORA_SF 9     // LoRa link spreading factor. Allowed values range from 6 to 12.
...
#define GLOBAL_LORA_CR 7    // LoRa link coding rate denominator. Allowed values range from 5 to 8.
