...
String WIFI_SSID =  "ServerIoT";  
String WIFI_PASS =  "deviotsolution";
...
String MQTT_ADDR  = "192.168.49.101";
String MQTT_PORT  = "1883";// Default MQTT port is 1883
#define MQTT_AUTH   //Enable MQTT authentication 
String MQTT_USER  = "deviot";
String MQTT_PASS  = "deviot";

String TOPIC_DATA  =  "iota32Server/data";
String TOPIC_STATUS = "iota32Server/status";
String TOPIC_COMMAND = "iota32Server/command";
