...
//Addresses
uint8_t UNIT_MAC = 0x09;  // The address of this gateway
...
#define LORAG_ACT      sendESPNowNbr(1);sendLoRaNbr(1);
#define SERIAL_ACT     
#define MQTT_ACT          
#define INTERNAL_ACT   sendLoRaNbr(1);
#define ESPNOW1_ACT    sendLoRaNbr(1);broadcastLoRa();
#define ESPNOW2_ACT                    
#define LORA1_ACT      sendESPNowNbr(1);sendLoRaNbr(1);
#define LORA2_ACT      
